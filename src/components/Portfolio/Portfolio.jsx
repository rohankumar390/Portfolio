...
const Portfolio = () => {
  return (
    <motion.section style={{backgroundColor:"black"}}
      ...
      <div className={`innerWidth flexCenter ${css.container}`}>
        ...
        <motion.div variants={textVariant(.4)} className={`flexCenter ${css.heading}`}>
          <div>
            ...
            <p style={{marginTop: "10px",colors:'White'}}>Perfect solution for digital experience</p>
          </div>
          <span className="secondaryText">Explore More Works</span>
        </motion.div>


        <div className={`flexCenter ${css.showCase}`} style={{backgroundColor:"white"}}>
